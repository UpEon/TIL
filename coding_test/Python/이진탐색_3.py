...
'''
전자 매장에는 부품이 N개 있다. 각 부품은 정수 형태의 고유한 번호가 있다. 어느 날 손님이 M개 종류의
부품을 대량으로 구매하겠다며 당일 날 견적서를 요청했다. 
...
출력 조건
- 첫째 줄에 공백으로 구분하여 각 부품이 존재하면 yse를, 없으면 no를 출력한다.
